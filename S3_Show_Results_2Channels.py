...
if not BN.any():
    ...
    if result:
        ...
        f1.savefig(os.path.join(PATH_OUT_FOLDER, "S_vs_E_scatter_plot.png"), bbox_inches=bbox1, dpi=300)
        f1.savefig(os.path.join(PATH_OUT_FOLDER, "ALEX2CDE_vs_E_scatter_plot.png"), bbox_inches=bbox2, dpi=300)
        f1.savefig(os.path.join(PATH_OUT_FOLDER, "FRET2CDE_vs_E_scatter_plot.png"), bbox_inches=bbox3, dpi=300)
        f1.savefig(os.path.join(PATH_OUT_FOLDER, "E_histogram.png"), bbox_inches=bbox4, dpi=300)
        f1.savefig(os.path.join(PATH_OUT_FOLDER, "RelTauD_vs_E_scatter_plot.png"), bbox_inches=bbox5, dpi=300)
        f1.savefig(os.path.join(PATH_OUT_FOLDER, "Lifetime_histograms.png"), bbox_inches=bbox6, dpi=300)
