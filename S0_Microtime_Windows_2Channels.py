...
DONOR_CHANNEL = 1 # channel of the donor signal
ACCEPTOR_CHANNEL = 2 # channel of the acceptor signal

NUM_CHANNELS = 0 # number of microtime channels - gets calculated if zero
############################################################################
